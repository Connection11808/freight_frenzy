...
public class ImageProcessingRed {
            ...
            if (updatedRecognitions != null) {
                ...
                for (Recognition recognition : updatedRecognitions) {
                    ...
                    if (recognition.getLabel() == "Duck")
                    {
                        ...
                        Log.d(TAG, "Find Duck" + " " + i + "," + "left =" + " " + left);
                    }
                ...
                if (i == 0)
                {
                    ...
                    duckPosition = DuckPositionRed.RIGHT;
                }
                else if (i == 1)
                {
                    if (left > 400)
                    ...
                    else if (left < 200)
                    {
                        ...
                        duckPosition = DuckPositionRed.LEFT;
                    }
                    else
                    {
